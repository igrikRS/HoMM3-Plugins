...
// исправление разсихронизации в сети: передача на уделенный ПК параметров всех стеков
...
// исправление разсихронизации в сети: получение на уделённом ПК параметров всех стеков
// и их выборочное внесение в o_BattleMgr
